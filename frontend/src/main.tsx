...
function App() {
  ...
  return <div className="site">
    ...
    {tab === 'overview' && <>
      <main>
        <section className="hero shell reveal reveal-hero">
          <div className="hero-copy reveal-child">
            ...
            <div className="hero-subtitle">Innovative Credit &amp; Finance Token</div>
          ...
          <div className="coin-stage reveal-child">
            <div className="coin-shadow" />
            <div className="coin" aria-label="ICFT token">
              <div className="coin-edge" />
              <div className="coin-highlight" />
              <div className="coin-ring ring-one" />
              <div className="coin-ring ring-two" />
              <div className="coin-ring ring-three" />
        ...
        <section className="ticker"><div>ETH COLLATERAL <span>•</span> ICFT CREDIT <span>•</span> RISK ENGINE <span>•</span> ORACLE VALUATION <span>•</span> ETH COLLATERAL <span>•</span> ICFT CREDIT</div></section>
        ...
        <section className="markets-section reveal"><div className="shell">
          ...
          <div className="market-grid"><Market pair="ICFT / USDT" status="Planned" text="Liquidity market for converting ICFT credit into external stablecoin liquidity." /><Market pair="ICFT / ETH" status="Planned" text="Future market for deeper ecosystem liquidity and collateral-native routes." /></div>
        </div></section>
